...
export default function Card({ title, children, href }: { title: string; children: ReactNode; href: string }) {
  return (
    <a
      className="ui-group ui-rounded-lg ui-border ui-border-transparent ui-px-5 ui-py-4 ui-transition-colors ui-bg-slate-200 hover:ui-border-neutral-700 hover:ui-bg-neutral-800/30"
